...
- Without transpilation it's possible to have JSX-like experience with HTML tagged templates, and I used [htm](https://github.com/developit/htm) for that (implemented by the developer of Preact).
